    ...
    Tables: {
      ...
      genepress_source_specs: {
        Row: {
          ...
          spec_origin: "intake" | "manual" | "generated" | "composed" | "built";
          slot_definitions: Json;
          structural_rules: Json;
          validation_result: "passed" | "failed" | "warnings" | null;
          source_checksum: string | null;
          parser_version: string | null;
          operator_id: string | null;
          sanitization_status: "not_run" | "passed" | "failed";
      ...
      genepress_compiled_variants: {
        Row: {
          ...
          // Adapter-layer columns added in migration 20260322000004
          compiled_json: Json | null;
          compile_warnings: Json;
          is_active: boolean;
          capability_profile: Json | null;
          downgrade_path: Json | null;
          builder_version: string | null;
          adapter_version: string | null;
          target_editor_mode: string | null;
          component_id: string | null;
          export_safety_flags: Json | null;
          fixture_suite_version: string | null;
        };
        Insert: {
          id?: string;
          created_at?: string;
